...
HD_PWD='L:/FPGA_Projects/02_KintexBoard_Playground/01_uart_to_usb/01_uart_to_usb.runs/uart_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_pll.tcl
